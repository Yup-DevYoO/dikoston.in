...
function data_overlay() {
    $("[data-overlay-color]").each(function (e) {
        var t = $(this),
            n = hvdcl.removeAttr(t, "data-overlay-color");
        t.addClass("hvdcl-overlay-" + e), $("body").append("<style>.hvdcl-overlay-" + e + "[data-overlay]:before{background: " + n + ";}</style>")
    })
}
...
function slick_client(e) {
    ...
    t.length > 0 && (t.slick({
        ...
        speed: 700
    }), e.width() > 991 && (hvdcl.parallaxMoveElemnt(t.find(".fas.fa-angle-right"), 25), hvdcl.parallaxMoveElemnt(t.find(".fas.fa-angle-left"), 25)))
}
...
function initMap() {
    ...
    function t(r) {
        data_overlay(),
            function () {
                if (e('[data-hvdcl-temp="light"]').length > 0) {
                    i.addClass("v-light");
                    let t = e('[data-hvdcl-header="project"]');
            ...
            function (s) {
                const r = "hvdcl-effect-animate",
                    l = '[data-hvdcl-ajax="img"]';
                var d = !0;
                return {
                    main_root: e("main.main-root"),
                    ajax_click: e("a.effect-ajax "),
                    isEffectAjax: function () {
                        return !i.hasClass("hvdcl-ajax")
                    },
                    ajaxLoad: function () {
                        var t = this;
                    ...
                    ajaxSlider: function (t, n) {
                        let a = this,
                            i = t.parents(".slide-content").data("hvdcl-id"),
                            o = e('.hvdcl-slider .slide-item[data-hvdcl-id="' + i + '"] .cover-bg').first(),
                            s = n;
                        void 0 !== s && TweenMax.to(".project-metas , .nav-slider ,.footer-slid ,.view-all , .hvdcl-all-work ", .8, {
                            autoAlpha: 0,
                            scale: .8,
                            onComplete: function () {
                                o.removeClass("hidden"), o.find("img").addClass("hidden"), a.createElement(o, s, e(".hvdcl-root-slider"))
                            }
                        })
                    },
                    ajaxList: function (t, n) {
                        let a = this,
                            o = e(".nav-work-img-box img.hvdcl-active").first(),
                            s = n;
                        void 0 !== s && TweenMax.to(".nav-work-box .list-main", .8, {
                            autoAlpha: 0,
                            onComplete: function () {
                                a.createElement(o, s), setTimeout(function () {
                                    i.removeClass("hvdcl-show-work")
                                }, 1e3)
                            }
                        })
                    },
                    ...
                    addElement: function (e, t, n) {
                        ...
                        return void 0 === i && (i = {
                            ...
                            transition: "",
                            objectFit: "cover"
                        }), a.css(hvdcl.getBoundingClientRect(n[0])), e.append(a), a
                    },
                    ajaxNormal: function (t) {
                        ...
                        a.scrollTop() < r && TweenMax.fromTo(this.main_root, 1, {
                            ...
                            onComplete: function () {
                                o.loader(t, function () {
                                    hvdcl.scrollTop(0, 1), n().unlocked()
                                })
                            }
                        })
                    },
                    ...
                    loader: function (t, n) {
                        var a = this;
                        i.removeClass("hvdcl-effect-animate"), this.main_root.load(t + " main.main-root > *", function (i, o, s) {
                            var r = e(this);
                    ...
                    ajaxNext: function (t, n) {
                        var a = e('.hvdcl-imgs[data-hvdcl-next="blog"]'),
                            i = this;
                        a.length <= 0 ? i.ajaxNormal(n) : (TweenMax.set(a, {
                            ...
                            ease: Expo.easeInOut,
                            onComplete: function () {
                                e('[data-hvdcl-header="blog"]').css("width", "100%"), i.createElement(a, n)
                            }
                        }))
                    },
                    ...
                    ajaxLoaderElemnt: function (e) {
                        e ? i.addClass("hvdcl-ajax-effect") : i.removeClass("hvdcl-ajax-effect")
                    }
                }
            }(r).ajaxLoad(),
            function (t) {
                function a() {
                    hvdcl.elementHover(i, "a.link-pop , a > img", "cursor-view"), hvdcl.elementHover(i, ".close-wind", "cursor-close"), hvdcl.elementHover(i, "a:not(> img) , .hvdcl-button-sidebar,  button", "cursor-link")
                }
                const i = ".cursor";
                if (n().isMobiles()) return;
                if (void 0 !== t && !0 === t) return void a();
                if (e("body").hasClass("hvdcl-large-mobile")) return;
                hvdcl.mouseMove(i), a()
                ...
                fade: !0,
                cssEase: "linear"
            }), e(' .our-news .slick-slider , .our-team .slick-slider , [data-hvdcl-col="2"] .slick-slider').slick({
                infinite: !0,
                slidesToShow: 2,
                arrows: !1,
                dots: !0,
            ...
            }), e('[data-hvdcl-col="3"] .slick-slider').slick({
                infinite: !0,
                slidesToShow: 3,
                arrows: !1,
                dots: !0,
            ...
            function () {
                ...
                t.on("click", function () {
                    i.toggleClass("hvdcl-show-work")
                });
                const n = e(".nav-work-box").find(".work-item"),
                    a = e(".nav-work-img-box");
                n.each(function (t) {
                    let n = e(this);
                    n.attr("data-hvdcl-id", t);
                    let i = n.find("img");
                    i.attr("data-hvdcl-id", t), n.hasClass("hvdcl-active") && i.addClass("hvdcl-active"), a.append(i)
                }), n.on("mouseenter", function () {
                    let t = function (e) {
                        let t = e.data("hvdcl-id");
                        return a.find('img[data-hvdcl-id="' + t + '"]')
                    }(e(this));
                    if (t.hasClass("hvdcl-active") || i.hasClass("hvdcl-ajax-effect")) return;
                    n.removeClass("hvdcl-active"), e(this).addClass("hvdcl-active");
                    let o = a.find(".hvdcl-active");
                    a.find("img").removeClass("hvdcl-active").removeClass("hvdcl-active-enter").removeClass("hvdcl-active-leve"), o.addClass("hvdcl-active-leve"), t.addClass("hvdcl-active hvdcl-active-enter")
                })
            }(),
            function () {
                const t = e(".hvdcl-slider"),
                    n = 1.2;
                return {
                    initSlider: function () {
                        const n = t.find(".slide-item"),
                            a = t.find(".hvdcl-slider-content");
                        n.each(function (t) {
                            e(this).attr("data-hvdcl-id", t);
                            let n = e(this).find(".slide-content");
                            n.attr("data-hvdcl-id", t), 0 === t && n.addClass("hvdcl-active hvdcl-active-cat"), a.append(n);
                            let i = n.find(".title-text-header-inner a");
                            hvdcl.convertTextLine(i, i)
                        })
                    },
                    progress: function (e) {
                    ...
                    slideChange: function (a) {
                        ...
                        a.on("slideChange", function () {
                            let o = t.find(".hvdcl-slider-content .hvdcl-active"),
                                s = o.data("hvdcl-id");
                            let r = e(a.slides[a.activeIndex]).data("hvdcl-id");
                            if (s === r) return;
                            t.find('[data-hvdcl="video"] video').each(function () {
                                this.pause()
                            });
                            let l = e(this.slides[this.activeIndex]).find('[data-hvdcl="video"] video');
                            l.length > 0 && l[0].play();
                            let d = o.find(".hvdcl-chars-wrapper");
                            o.removeClass("hvdcl-active-cat");
                            let c = t.find('.hvdcl-slider-content [data-hvdcl-id="' + r + '"]'),
                                u = c.find(".hvdcl-chars-wrapper"),
                                f = s > r,
                                h = new TimelineLite;
                            h.staggerFromTo(hvdcl.randomObjectArray(d, .3), .3, i.showText().title, i.hideText(f).title, .1, 0, function () {
                                t.find(".hvdcl-slider-content .slide-content").removeClass("hvdcl-active"), t.find(".hvdcl-slider-content .slide-content").removeClass("hvdcl-active-cat"), c.addClass("hvdcl-active"), c.addClass("hvdcl-active-cat")
                            }), h.staggerFromTo(hvdcl.randomObjectArray(u, n), n, i.hideText(f).title, i.showText().title, .1, "-=.8")
                        })
                    },
                    showText: function () {
                        return {
                    ...
                    swiperObject: function () {
                        return new Swiper(".hvdcl-slider .slide-inner", {
                            loop: true,
                            autoplay: 1500,
                            speed: 1000,
                            allowTouchMove: !0,
                            resistanceRatio: .65,
                            navigation: {
                                nextEl: ".hvdcl-slider .control-nav .next-container",
                                prevEl: ".hvdcl-slider .control-nav .prev-container"
                            },
                            pagination: {
                                el: ".hvdcl-slider .footer-slid .control-num span",
                                type: "custom",
                                clickable: !0,
                                renderCustom: function (e, t, n) {
                                    return hvdcl.numberText(t)
                                }
                            },
                            on: {
                                init: function () {
                                    //this.autoplay.stop(), t.find('[data-hvdcl="video"] video').each(function () {
                                    //    this.pause()
                                    //})
                                },
                                imagesReady: function () {
                                    let t = e(this.slides[this.activeIndex]).find('[data-hvdcl="video"] video');
                                    t.length > 0 && t[0].play()
                                }
                            }
                        })
    ...
    function n() {
        ...
        var n = document.querySelector("#hvdcl-scrollbar");
        return {
            isMobile: function () {
            ...
            isScroller: function (e) {
                e && (n = document.querySelector("#hvdcl-scrollbar"));
                let t = !i.hasClass("hvdcl-effect-scroll") || this.isMobile() || null === n;
                return t && e && i.addClass("hvdcl-mobile"), !t
            },
            locked: function () {
            ...
            unlocked: function () {
                i.removeClass("locked-scroll"), this.start(), r.allInt(), hvdcl.progressCircle(s)
            },
            ...
            start: function () {
                if (hvdcl.scrollTop(0, 1), e(".scroll-to").on("click", function (t) {
                        t.preventDefault();
                        let n = a;
            ...
            sidebarScroll: function () {
                const e = document.querySelector(".hvdcl-sidebar .sidebar-single");
                null !== e && t.init(e, {
                    damping: .05
                })
            },
            workScroll: function () {
                const e = document.querySelector(".hvdcl-all-work .hvdcl-work-scrollbar");
                null !== e && t.init(e, {
                    damping: .05
                })
            }
    ...
    const a = e(window),
        i = e("body"),
        o = {
            animateTextAjax: '.hvdcl-nav-bar , .headefr-fexid .project-title .title-text-header .cat ,[data-hvdcl-animate="ajax"] , footer, .next-project , .root-project'
        };
    ! function () {
        var t = e(".preloader"),
            ...
            u = hvdcl.pageLoad(0, 100, 300, function (e) {
    ...
    function () {
        ...
        if (!(n.length <= 0)) {
            var o = n.find(".text-button"),
                s = n.find(".text-open"),
                r = n.find(".text-close");
            hvdcl.convertTextWord(o, o, !0), hvdcl.convertTextWord(s, s, !0), hvdcl.convertTextWord(r, r, !0)
        }
    }();
    var s = n(),
        r = function () {
            var t = new ScrollMagic.Controller;
            const n = '[data-hvdcl-header="project"]',
                o = '[data-hvdcl-footer="project"]';
            return {
                ...
                headerProject: function () {
                    ...
                    let a = e("#hvdcl-hero-parallax-img"),
                        o = e("#hvdcl-hero-parallax-title"),
                        s = e("#hvdcl-hero-parallax-fill-title"),
                        r = e("#descover-holder"),
                        l = 1.2;
                    a.hasClass("parallax-move-element") && hvdcl.parallaxMoveElemnt({
                        target: e(n),
                    ...
                    if (o.length > 0 && (o.hasClass("project-title") && (l = 1), d.to(o, .8, {
                            ...
                            force3D: !0,
                            height: 80
                        }, 0).to("#hvdcl-hero-parallax-fill-title h1", 1, {
                            force3D: !0,
                            top: 0
                ...
                nextProject: function () {
                    let n = e("#hvdcl-next-parallax-img"),
                        a = e("#hvdcl-next-parallax-title"),
                ...
                parallaxImg: function () {
                    e('[data-hvdcl-grid="move-up"]').each(function () {
                        let n = e(this);
                        n.attr("data-hvdcl-grid", "moveUp");
                        let a = n.find("img:not(.hidden) , video"),
                            i = hvdcl.getUndefinedVal(n.data("hvdcl-triggerhook"), 1),
                            o = hvdcl.getUndefinedVal(n.data("hvdcl-duration"), 1 !== i ? "100%" : "200%");
                        if (a.length > 0) {
                            var r;
                            if (a.hasClass("has-top-bottom")) {
                                let e = hvdcl.getUndefinedVal(a.data("hvdcl-move"), "15%");
                                r = TweenMax.to(a, .8, {
                                    force3D: !0,
                                    y: e,
                                    ease: Power0.easeNone
                                ...
                                let e = hvdcl.getUndefinedVal(a.data("hvdcl-y"), "10%"),
                                    t = hvdcl.getUndefinedVal(a.data("hvdcl-scale"), 1.1);
                ...
                moveSection: function () {
                    e('[data-hvdcl-grid="move-section"]').each(function () {
                        let n = e(this);
                        n.removeAttr("data-hvdcl-grid"), n.addClass("hvdcl-move-section");
                        let i = hvdcl.getUndefinedVal(n.data("hvdcl-move"), -100),
                            o = hvdcl.getUndefinedVal(n.data("hvdcl-triggerhook"), 1),
                            r = hvdcl.getUndefinedVal(n.data("hvdcl-opacity"), n.css("opacity")),
                            l = hvdcl.getUndefinedVal(n.data("hvdcl-duration"), "150%");
                        if ("tablet" === n.data("hvdcl-responsive") && a.width() < 992) return;
                ...
                parallaxImgHover: function () {
                    const t = e('[data-hvdcl="parallax"]');
                    0 === t.length || a.width() < 992 || t.each(function () {
                        var t = e(this),
                            n = (hvdcl.removeAttr(t, "data-hvdcl"), hvdcl.removeAttr(t, "data-hvdcl-speed")),
                            a = hvdcl.removeAttr(t, "data-hvdcl-move"),
                            i = !1;
                        t.hasClass("image-zoom") && (i = !0), hvdcl.parallaxMoveElemnt(t, a, n, void 0, i)
                    })
                },
                changeColor: function () {
                    const n = "v-light";
                    var a = i.hasClass(n);
                    e('[data-hvdcl="color"]').each(function () {
                        let o = hvdcl.getUndefinedVal(e(this).data("hvdcl-duration"), e(this).outerHeight() + 70);
                ...
                animateText: function () {
                    e('[data-hvdcl-animate="text"] , [data-hvdcl-animate="up"]').each(function () {
                        let n = e(this),
                            a = 1;
                        "text" === n.data("hvdcl-animate") ? (hvdcl.convertTextWord(n, n), n.attr("data-hvdcl-animate", "animate")) : a = .8;
                        var i = new ScrollMagic.Scene({
                            triggerElement: this,
                            reverse: !1,
                            triggerHook: a
                        }).setClassToggle(this, "hvdcl-active").addTo(t);
                        s.getListener(function () {
                            i.refresh()
                        })
                    })
                ...
                headerBlog: function () {
                    const n = e('[data-hvdcl-header="blog"]');
