var $ = jQuery,
    ...
    hvdcl = {
        ...
        scaleIt: function (e, n, t) {
            ...
            var o = 0;
            o = body.hasClass("hvdcl-effect-scroll") ? e.scrollTop : e.scrollTop();
            var i, a, s;
            s = this.getUndefinedVal(t.plus, 0), i = this.getUndefinedVal(t.position, !1);
            var r = n.offset();
            a = void 0 === r || body.hasClass("hvdcl-effect-scroll") ? 0 : r.top, i && (a -= o);
        ...
        setPositionMoveSection: function (e, n, t) {
            if (void 0 !== e) {
                var o = e.offset(),
                    i = void 0 === o ? 0 : o.top;
                n = hvdcl.getUndefinedVal(n, 2), t = hvdcl.getUndefinedVal(t, 0);
        ...
        scrollTop: function (e, n, t, o) {
            n = hvdcl.getUndefinedVal(n, 500), t = hvdcl.getUndefinedVal(t, 0);
            var i = 0;
        ...
        mouseMove: function (e, n, t) {
            jQuery(window);
            var o = jQuery("body");
            if (hvdcl.getUndefinedVal(o.data("hvdcl-mousemove"), !1) && void 0 !== e && !(e.length <= 0) && null !== e) {
                o.addClass("hvdcl-mousemove"), e instanceof jQuery == !1 && (e = jQuery(e));
                var i = e,
                    a = !1;
                o.on("mousemove", function (e) {
                    TweenLite.to(i, .5, {
                        left: e.pageX,
                        top: e.pageY
                    }) /*i.css({left:e.pageX,top:e.pageY})*/ , void 0 !== n && void 0 !== n.onUpdate && n.onUpdate(e, e.pageX, e.pageY, i), void 0 !== n && void 0 !== n.onComplete && (a = !0, hvdcl.endAnimate(i, function (e) {
        ...
        convertTextLine: function (e, n) {
            var t = e.html().trim(),
                o = "";
            e.html("");
            for (var i = 0; i < t.length; i++) 0 === i && (o += '<div class="hvdcl-word-wrapper">'), " " !== t.charAt(i) ? o += '<span class="hvdcl-chars-wrapper">' + t.charAt(i) + "</span>" : o += "</div>" + t.charAt(i) + '<div class="hvdcl-word-wrapper">';
            o += "</div>", n.append(o)
        },
        ...
        convertTextWord: function (e, n, t) {
            ...
            for (var a = 0; a < o.length; a++)
                if (o[a].length > 0) {
                    if (i += '<span class="hvdcl-wrapper">', t) {
                        i += '<span class="hvdcl-word-wrapper">';
                        for (var s = 0; s < o[a].length; s++) i += '<span class="hvdcl-chars-wrapper">' + o[a].charAt(s) + "</span>";
                        i += "</span>"
                    } else i += '<span class="hvdcl-word-wrapper">' + o[a] + "</span>";
                    i += "</span>"
                } n.append(i)
        },
        ...
        embedVideo: function (e) {
            jQuery("[data-hvdcl-video]").each(function (e) {
                var n = jQuery(this),
                    t = hvdcl.removeAttr(n, "data-hvdcl-video");
                n.on("click", function () {
                    n.addClass("hvdcl-video"), n.html('<div class="hvdcl-iframe-player">' + t + "</div>"), hvdcl.scrollTop(n, 1600, -100)
                })
            })
        },
        ...
        parallaxMoveElemnt: function (e, n, t, o, i) {
            ...
            if (void 0 !== e.target && (a = e.target, s = void 0 !== e.element ? e.element : e.target), !(s.length <= 0)) {
                ...
                a.append(r), a.off("mouseleave"), a.off("mouseenter"), a.off("mousemove"), a.on("mouseleave", function (e) {
                    ...
                    hvdcl.parallaxIt(e, s, n), hvdcl.parallaxIt(e, r, 2 * n), void 0 !== o && hvdcl.parallaxIt(e, o, -5, .5)
                })
            }
        },
        parallaxMoveElemntCir: function (e, n, t, o, i) {
            ...
            var r = a.html(),
                ...
                l = $('<div class="hvdcl-grid-parallax">' + r + "</div>");
            a.html(""), a.append(d), a.append(l), a.on("mouseleave", function (e) {
                ...
                s.parallaxIt(e, l, n), hvdcl.parallaxIt(e, d, n)
            })
        },
        ...
        animateText: function (e, n, t, o) {
            function i() {
                ...
                let e = $(this);
                hvdcl.convertTextWord(e, e), void 0 !== t && e.attr(t, "animate"), void 0 !== o && e.removeClass(o), e.addClass("hvdcl-has-animate-text")
            });
            const a = "hvdcl-animate";
            var s = 0,
                r = null;
        ...
        imageLoad: function () {
            const e = $('[data-hvdcl-loader="div"]');
            e.each(function () {
                $(this).append('<div class="wait-loader"><div class="loader-inner"><div class="loader-circle"><div class="loader-layer"></div></div></div></div>')
            });
            e.imagesLoaded({
                background: ".hvdcl-img-org"
            }).progress(function (e, n) {
                let t = $(n.element).parents('[data-hvdcl-loader="div"]');
                t.length > 0 && (t.addClass("hvdcl-img-loader-done hvdcl-animate"), t.attr("data-hvdcl-loader", "divFinshed"))
            })
        },
        ...
        progressCircle: function (e) {
            const n = $('[data-hvdcl-grid="progress-circle"]'),
                t = this.removeAttr(n, "data-hvdcl-grid-stroke");
            ...
            n.css({
                ...
                height: "52px",
                "z-index": "99999999"
            }), n.append('<svg class="hvdcl-progress-circle-up" width="100%" height="100%" ' + o + ' viewBox="0 0 100 100" preserveAspectRatio="xMinYMin meet" fill="none">\n        <path class="hvdcl-progress-path" d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98" style="transition:  stroke-dashoffset 300ms linear 0s;stroke-dasharray: 307.919, 307.919; stroke-dashoffset: 309;"></path>    </svg>');
            var i = wind;
            e.isScroller(!0) && (i = e.getScrollbar()), e.getListener(function (e) {
                ...
                void 0 === e.offset ? t = wind.scrollTop() : (t = e.offset.y, o = $(document).height() - i.getSize().content.height + 100), t > 70 ? (TweenMax.to(n, 1, {
                    ease: Back.easeOut.config(4),
                    right: 60
                }), n.find(".hvdcl-progress-path").css("stroke-dashoffset", 300 - Math.round(300 * t / o) + "%")) : TweenMax.to(n, 1, {
